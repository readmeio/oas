 ...
 */
OpenAPIParser.prototype.parse = async function (path, api, options) {
 ...
 * @returns {Promise} - The returned promise resolves with the parsed API object.
 */
OpenAPIParser.validate = function (path, api, options) {
  const Class = this;
 ...
 * @returns {Promise} - The returned promise resolves with the parsed API object.
 */
OpenAPIParser.prototype.validate = async function (path, api, options) {
  const me = this;
  const args = normalizeArgs(arguments);
  args.options = new Options(args.options);
