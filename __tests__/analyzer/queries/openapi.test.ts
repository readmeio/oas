...
describe('analyzer queries (OpenAPI)', () => {
  ...
  describe('parameter serialization', () => {
    it('should discover parameter serialization usage within a definition that has it', () => {
      expect(QUERIES.parameterSerialization(parameterStyles)).toStrictEqual([
        '#/paths/~1anything~1headers~1simple/get/parameters/0/style',
        '#/paths/~1anything~1headers~1simple/get/parameters/1/style',
        '#/paths/~1anything~1headers~1simple/get/parameters/2/style',
        '#/paths/~1anything~1headers~1simple/post/parameters/0/style',
        '#/paths/~1anything~1headers~1simple/post/parameters/1/style',
        '#/paths/~1anything~1headers~1simple/post/parameters/2/style',
        '#/paths/~1anything~1path~1label~1{primitive}~1{array}~1{object}/get/parameters/0/style',
        '#/paths/~1anything~1path~1label~1{primitive}~1{array}~1{object}/get/parameters/1/style',
        '#/paths/~1anything~1path~1label~1{primitive}~1{array}~1{object}/get/parameters/2/style',
        '#/paths/~1anything~1path~1label~1{primitive}~1{array}~1{object}/post/parameters/0/style',
        '#/paths/~1anything~1path~1label~1{primitive}~1{array}~1{object}/post/parameters/1/style',
        '#/paths/~1anything~1path~1label~1{primitive}~1{array}~1{object}/post/parameters/2/style',
        '#/paths/~1anything~1path~1matrix~1{primitive}~1{array}~1{object}/get/parameters/0/style',
        '#/paths/~1anything~1path~1matrix~1{primitive}~1{array}~1{object}/get/parameters/1/style',
        '#/paths/~1anything~1path~1matrix~1{primitive}~1{array}~1{object}/get/parameters/2/style',
        '#/paths/~1anything~1path~1matrix~1{primitive}~1{array}~1{object}/post/parameters/0/style',
        '#/paths/~1anything~1path~1matrix~1{primitive}~1{array}~1{object}/post/parameters/1/style',
        '#/paths/~1anything~1path~1matrix~1{primitive}~1{array}~1{object}/post/parameters/2/style',
        '#/paths/~1anything~1path~1simple~1{primitive}~1{array}~1{object}/get/parameters/0/style',
        '#/paths/~1anything~1path~1simple~1{primitive}~1{array}~1{object}/get/parameters/1/style',
        '#/paths/~1anything~1path~1simple~1{primitive}~1{array}~1{object}/get/parameters/2/style',
        '#/paths/~1anything~1path~1simple~1{primitive}~1{array}~1{object}/post/parameters/0/style',
        '#/paths/~1anything~1path~1simple~1{primitive}~1{array}~1{object}/post/parameters/1/style',
        '#/paths/~1anything~1path~1simple~1{primitive}~1{array}~1{object}/post/parameters/2/style',
        '#/paths/~1anything~1query~1deepObject/get/parameters/0/style',
        '#/paths/~1anything~1query~1form/get/parameters/0/style',
        '#/paths/~1anything~1query~1form/get/parameters/1/style',
        '#/paths/~1anything~1query~1form/get/parameters/2/style',
        '#/paths/~1anything~1query~1form/post/parameters/0/style',
        '#/paths/~1anything~1query~1form/post/parameters/1/style',
        '#/paths/~1anything~1query~1form/post/parameters/2/style',
        '#/paths/~1anything~1query~1pipeDelimited/get/parameters/0/style',
        '#/paths/~1anything~1query~1pipeDelimited/get/parameters/1/style',
        '#/paths/~1anything~1query~1spaceDelimited/get/parameters/0/style',
        '#/paths/~1anything~1query~1spaceDelimited/get/parameters/1/style',
        '#/paths/~1cookies#formExploded/get/parameters/0/style',
        '#/paths/~1cookies#formExploded/get/parameters/1/style',
        '#/paths/~1cookies#formExploded/get/parameters/2/style',
        '#/paths/~1cookies#formNonExploded/get/parameters/0/style',
        '#/paths/~1cookies#formNonExploded/get/parameters/1/style',
        '#/paths/~1cookies#formNonExploded/get/parameters/2/style',
      ]);
    });
  ...
  describe('polymorphism', () => {
    it('should determine if a definition uses schema polymorphism', () => {
      expect(QUERIES.polymorphism(readme)).toStrictEqual([
        '#/components/responses/authForbidden/content/application~1json/schema/oneOf',
        '#/components/responses/authUnauthorized/content/application~1json/schema/oneOf',
        '#/components/schemas/error_APIKEY_EMPTY/allOf',
        '#/components/schemas/error_APIKEY_MISMATCH/allOf',
        '#/components/schemas/error_APIKEY_NOTFOUND/allOf',
        '#/components/schemas/error_APPLY_INVALID_EMAIL/allOf',
        '#/components/schemas/error_APPLY_INVALID_JOB/allOf',
        '#/components/schemas/error_APPLY_INVALID_NAME/allOf',
        '#/components/schemas/error_CATEGORY_INVALID/allOf',
        '#/components/schemas/error_CATEGORY_NOTFOUND/allOf',
        '#/components/schemas/error_CHANGELOG_INVALID/allOf',
        '#/components/schemas/error_CHANGELOG_NOTFOUND/allOf',
        '#/components/schemas/error_CUSTOMPAGE_INVALID/allOf',
        '#/components/schemas/error_CUSTOMPAGE_NOTFOUND/allOf',
        '#/components/schemas/error_DOC_INVALID/allOf',
        '#/components/schemas/error_DOC_NOTFOUND/allOf',
        '#/components/schemas/error_ENDPOINT_NOTFOUND/allOf',
        '#/components/schemas/error_INTERNAL_ERROR/allOf',
        '#/components/schemas/error_PROJECT_NEEDSSTAGING/allOf',
        '#/components/schemas/error_PROJECT_NOTFOUND/allOf',
        '#/components/schemas/error_REGISTRY_INVALID/allOf',
        '#/components/schemas/error_REGISTRY_NOTFOUND/allOf',
        '#/components/schemas/error_SPEC_FILE_EMPTY/allOf',
        '#/components/schemas/error_SPEC_ID_DUPLICATE/allOf',
        '#/components/schemas/error_SPEC_ID_INVALID/allOf',
        '#/components/schemas/error_SPEC_INVALID/allOf',
        '#/components/schemas/error_SPEC_INVALID_SCHEMA/allOf',
        '#/components/schemas/error_SPEC_NOTFOUND/allOf',
        '#/components/schemas/error_SPEC_TIMEOUT/allOf',
        '#/components/schemas/error_SPEC_VERSION_NOTFOUND/allOf',
        '#/components/schemas/error_UNEXPECTED_ERROR/allOf',
        '#/components/schemas/error_VERSION_CANT_DEMOTE_STABLE/allOf',
        '#/components/schemas/error_VERSION_CANT_REMOVE_STABLE/allOf',
        '#/components/schemas/error_VERSION_DUPLICATE/allOf',
        '#/components/schemas/error_VERSION_EMPTY/allOf',
        '#/components/schemas/error_VERSION_FORK_EMPTY/allOf',
        '#/components/schemas/error_VERSION_FORK_NOTFOUND/allOf',
        '#/components/schemas/error_VERSION_INVALID/allOf',
        '#/components/schemas/error_VERSION_NOTFOUND/allOf',
        '#/paths/~1api-specification/post/responses/400/content/application~1json/schema/oneOf',
        '#/paths/~1api-specification~1{id}/put/responses/400/content/application~1json/schema/oneOf',
        '#/paths/~1categories/post/requestBody/content/application~1json/schema/allOf',
        '#/paths/~1version/post/responses/400/content/application~1json/schema/oneOf',
      ]);
    });
  ...
  describe('server variables', () => {
    it('should determine if a definition uses server variables when it does', () => {
      expect(QUERIES.serverVariables(serverVariables)).toStrictEqual([
        '#/servers/0/variables',
        '#/servers/1/variables',
        '#/servers/2/variables',
      ]);
  ...
  describe('xml', () => {
    ...
    // `jsonpath` does not support `@property.match` queries.
    it.skip('should discover `+xml` vendor suffixes', () => {
      expect(
        QUERIES.xml({
          paths: {
            '/anything': {
